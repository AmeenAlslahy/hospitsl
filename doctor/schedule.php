...
<body>
    ...
    function showAppointmentDetails(appointmentId) {
        // هذا مثال - يجب استبداله بجلب البيانات الفعلية من الخادم
        const modalContent = `
            <div class="modal-patient-info">
                <div class="patient-avatar">JD</div>
                <div class="patient-details">
                    <h4>جون دوي</h4>
                    <span class="patient-id">#PAT-12345</span>
                </div>
            </div>
            ...
            <div class="appointment-meta">
                <div class="meta-item">
                    ...
                    <div class="meta-value">15 يونيو 2023 - 10:00 ص</div>
                </div>
                <div class="meta-item">
                    <div class="meta-label">المدة</div>
                    <div class="meta-value">30 دقيقة</div>
                </div>
                <div class="meta-item">
                    <div class="meta-label">الحالة</div>
                    <div class="meta-value"><span class="status-badge مؤكد">مؤكد</span></div>
                </div>
                <div class="meta-item">
                    <div class="meta-label">نوع الزيارة</div>
                    <div class="meta-value">فحص دوري</div>
                </div>
            </div>
            
            <div class="appointment-notes">
                <h5>ملاحظات</h5>
                <p>المريض يحتاج إلى فحص ضغط الدم ومستوى السكر. لديه حساسية من البنسلين.</p>
            </div>
        `;
        
        document.querySelector('.modal-appointment-details').innerHTML = modalContent;
